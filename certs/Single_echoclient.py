...
#myCmd = f'{lsquic_dir}/build/bin/./echo_client -C {cert_dir} -H www.example.com -s {serverIP}:4433 -p /'
myCmd = f'{lsquic_dir}/build/bin/./echo_client -H www.example.com -s {serverIP}:4433'
